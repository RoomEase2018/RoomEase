...
function getUserById(req, res, next) {
  db
  .one("select * from users where id = ${id}", { id: req.params.id } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
...
function getApartmentById(req, res, next) {
  db
  .one("select * from apartments where id = ${id}", { id: req.params.id } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
...
function getChoresByUserId(req, res, next) {
  db
  .any("select * from chores where posted_by_id = ${userid}", { userid: req.params.userid } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
...
function getChoresByApartmentId(req, res, next) {
  db
  .any("select * from chores where apartment_id = ${aptid}", { aptid: req.params.aptid } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
...
function getExpensesByUserId(req, res, next) {
  db
  .any("select * from expenses where payee_id = ${userid}", { userid: req.params.userid } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
...
function getExpensesByApartmentId(req, res, next) {
  db
  .any("select * from expenses where apartment_id = ${aptid}", { aptid: req.params.aptid } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
...
function getFixedExpensesByApartmentId(req, res, next) {
  db
  .any("select * from fixed_expenses where apartment_id = ${aptid}", { aptid: req.params.aptid } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
...
function getNotesByApartmentId(req, res, next) {
  db
  .any("select * from notes where apartment_id = ${aptid}", { aptid: req.params.aptid } )
  .then(function(data) {
    res.status(200).json({
      status: "success",
      data: data,
