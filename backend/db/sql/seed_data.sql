...
INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'clean gutter', 1, 2, '2018/03/21', '', 25);

INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'buy tp', 3, 1, '2018/03/22', '', 10);

INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'clear out basement', 3, 1, '2018/03/23', 'need space for party!', 20);

INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'clean microwave', 3, 1, '2018/03/25', '', 10);
...
INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'buy beer', 1, 2, '2018/04/09', 'get some IPAs for Rob', 10);

INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'rake leaves', 3, 1, '2018/04/11', 'rake is in the basement', 10);

INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'buy dish soap', 4, 1, '2018/04/12', 'almost out of dish soap', 10);

INSERT INTO tasks (apt_id, task_name, posted_by_id, assigned_to_id, due_date, message, karma_value) VALUES (1, 'clean bathroom', 1, 3, '2018/04/15', 'remember to clean the tub!', 50);

-- INSERTING RECURRING TASKS + COMPLETED
-- ################################################

INSERT INTO tasks_recurring (apt_id, task_name, posted_by_id, assigned_to_id, due_day, message, karma_value) VALUES (1, 'buy milk', 3, 1, 'sunday', 'buy whole milk', 10);

INSERT INTO tasks_recurring (apt_id, task_name, posted_by_id, assigned_to_id, due_day, message, karma_value) VALUES (1, 'clean bathroom', 2, 1, 'EOM', 'buy whole milk', 10);
...
INSERT INTO expenses (apt_id, expense_name, message, amount, payer_id, payee_id, due_date, karma_value) VALUES (1, 'for milk', '', 1.50, 1, 2, DATE '2018/03/14', 10);
...
INSERT INTO expenses_recurring (apt_id, expense_name, message, amount, payer_id, payee_id, due_day, karma_value) VALUES (1, 'rent', '', 650, 1, 2, 'EOM', 10);

INSERT INTO expenses_recurring (apt_id, expense_name, message, amount, payer_id, payee_id, due_day, karma_value) VALUES (1, 'utilities', '', 650, 1, 2, 'EOM', 10);
...
INSERT INTO goals_apartment (apt_id, posted_by, title, note, karma_cost) VALUES (1, 2, 'brunch on sunday', '', 50);
